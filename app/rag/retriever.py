...
from app.rag.embeddings import EmbeddingError, build_search_query
...
def retrieve_documents(
    ...
    try:
        ...
        raise QdrantUnavailableError(f"Query embedding failed: {exc}") from None
    ...
    except (QdrantConfigError, QdrantUnavailableError, ValueError, EmbeddingError):
        raise
